            ...
            <ul className="space-y-8 font-medium">
              <li>
                <a
                  ...
                  className="flex transition duration-300 ease-in-out items-center mt-10 p-4 py-4 text-gray-900 rounded-lg dark:text-gray-900 bg-gray-100 border-lightPurple hover:shadow-shadowPurple group"
                >
                  <svg
        ...
        <div className="p-4 xl:ml-80 bg-gray-50 dark:bg-ddbackground">
          <div className=" rounded-lg dark:border-bg-darkPurple">
            ...
            <div className="w-full flex flex-col lg:flex-row ">
              <div className="w-full lg:w-full lg:mr-4 bg-gray-200 dark:bg-dbackground p-4 mb-4 rounded-md">
                <WeeklyService />
