      ...
      try {
        if (selectedDate) {
          const response = await fetch(
            `http://localhost:8081/dailyfinanciallog/selected-forms-data?selectedDate=${selectedDate}`
          );
  ...
  return (
    <>
      <div className="w-full h-full flex flex-col items-center justify-center dark:ddbackground rounded-lg">
        <div className="w-full flex flex-col items-center justify-center dark:bg-ddbackground">
